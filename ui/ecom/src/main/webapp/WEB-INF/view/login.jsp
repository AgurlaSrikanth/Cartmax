...
<body>
    <nav class="navbar navbar-expand-lg bg-light" style="width:100%; height:60px;">
        <div class="container-fluid" style="font-weight: 900;">
          <a class="navbar-brand" href="#">Cartmax</a>
        ...
        <div class="container" style="margin-top:800px; margin-right:500px;width:500px;">
            <div class="contentBx">
        <div class="forms">
                   <div class="form login">
                       ...
                       <form action="#">
                           ...
                           <div class="input-field button">
                               <input type="button" onclick="login()" id="login">
                           </div>
                       </form>
    ...
    <div class="form-container">
        <div id="login-page">
            ...
            <div>
                ...
                <input id="username" type="text" name="username" placeholder="Email or Username" required />
            </div>
            <div>
            ...
            <div>Don't have account? <a href="#" id="signup-link">Signup here</a></div>
            </form>
        </div>
        <div id="signup-page">
            <form id="signup-form">
            ...
            <div>Already registered? <a class="login-link" href="#" id="login-link">Login here</a></div>
            </form>
        </div>
    </div>
